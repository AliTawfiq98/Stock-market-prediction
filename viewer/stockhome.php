...
<tr align= "left"style="font-size: 17px;" >
    ...
    <td><a class=edit data-toggle=modal href=predictstock.php?ticker=<?php echo $row['stockTicker']; ?>><i class=material-icons data-toggle=tooltip title=Predict>&#xe5c8;</i></a></td>  
</tr>
</div>
    </div>
    </div>
